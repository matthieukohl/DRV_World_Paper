...
[ha,pos] = tight_subplot(3,2,[0.03 0.03],[.035 .03],[.042 .1]);
...
path_root = '/nobackup1c/users/mkohl/linear_gradient_formulation/primitive_equations_constant_strat_r001_eps01_final_high_temp_output_with_advection';
...
annotation('textbox',[0.885,0.19,0.15,0.01],'String',['Vertical' newline 'Velocity' newline '(Mid Layer)'],'EdgeColor','none','FontSize',11);

% titles

annotation('textbox',[0.12,0.99,0.3,0.01],'String',"High Rossby Regime (\epsilon=0.4)",'EdgeColor','none','FontSize',12);
annotation('textbox',[0.56,0.99,0.3,0.01],'String',"Low Rossby Regime (\epsilon=0.01)",'EdgeColor','none','FontSize',12);
...
'adv_correct/full_relax_correct/equations_correct_nd/primitive_equations_final/'...
   'primitive_equations_constant_strat_r001_eps04_geostrophic/figures_drv_world/pe_eps04_eps01'];
