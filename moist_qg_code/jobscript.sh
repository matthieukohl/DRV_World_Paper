...
#SBATCH -J qg_r001 # sensible name for the job
...
mpiexec -n 16 -mca btl_tcp_if_include ib0 python3 main.py
mpiexec -n 16 -mca btl_tcp_if_include ib0 python3 -m dedalus merge_procs snapshots --cleanup
mpiexec -n 16  -mca btl_tcp_if_include ib0 python3 -m dedalus merge_procs time_series --cleanup
