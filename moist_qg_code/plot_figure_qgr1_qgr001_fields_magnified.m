...
subplot(3,2,1)
%imshow(zeta1)
imshow(zeta1,'XData',linspace(0,12*pi/mag,512),'Ydata',linspace(0,12*pi/mag,512)); colorbar; caxis([-max(max(zeta1)) max(max(zeta1))])
%
...
subplot(3,2,3)
%imshow(zeta2)
imshow(zeta2,'XData',linspace(0,12*pi/mag,512),'Ydata',linspace(0,12*pi/mag,512)); colorbar; caxis([-max(max(zeta2)) max(max(zeta2))])
...
subplot(3,2,5)
%imshow(w)
imshow(w,'XData',linspace(0,12*pi/mag,512),'Ydata',linspace(0,12*pi/mag,512)); colorbar; 
...
subplot(3,2,6)
%imshow(w)
imshow(w,'XData',linspace(0,12*pi/magw,512),'Ydata',linspace(0,12*pi/magw,512)); colorbar; 
%caxis([-max(max(w)) max(max(w))])
%contourf(X,Y,w,'Edgecolor','none');
%colormap(redblue(colorint))
%colormap(redbluecmap(colorint))
...
'figures_paper/qg_r1_vs_qg_r001_snapshots_linear_tau_damping_alpha_1p7_magnified'],'epsc')
